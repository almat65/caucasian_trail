...
TRANSLATIONS = {
    'en': {
        ...
        'create_photos': "📸 Now send photos for this day (as images, not files).\n\nPhotos will be named: day_{day}_01.jpg, day_{day}_02.jpg, etc.\n\nSend all photos, then type 'done' when finished.\nOr type 'skip' if no photos.",
        'photo_uploaded': "✅ Uploaded: {filename}\n\nTotal photos: {count}\n\nSend more photos or type 'done' to finish.",
        'photo_upload_error': "❌ Error uploading photo: {error}\n\nTry again or type 'skip' to continue without photos.",
        'photo_invalid_command': "Please send photos or type 'done' or 'skip'.",
        ...
        'update_photos_prompt': "📸 Upload photos for Day {day}\n\nPhotos will be named: day_{day}_01.jpg, day_{day}_02.jpg, etc.\n\nSend photos now, then type 'done' when finished.\nType 'skip' to cancel.",
        'update_cancelled': "↩️ Update cancelled. Returning to menu.\n\nUse /start for more options.",
    ...
    'ru': {
        ...
        'create_photos': "📸 Теперь отправьте фотографии этого дня (как изображения, не файлы).\n\nФото будут названы: day_{day}_01.jpg, day_{day}_02.jpg, и т.д.\n\nОтправьте все фото, затем напишите 'done' когда закончите.\nИли напишите 'skip' если нет фото.",
        'photo_uploaded': "✅ Загружено: {filename}\n\nВсего фото: {count}\n\nОтправьте ещё фото или напишите 'done' чтобы закончить.",
        'photo_upload_error': "❌ Ошибка загрузки фото: {error}\n\nПопробуйте снова или напишите 'skip' чтобы продолжить без фото.",
        'photo_invalid_command': "Пожалуйста отправьте фото или напишите 'done' или 'skip'.",
        ...
        'update_photos_prompt': "📸 Загрузите фотографии для Дня {day}\n\nФото будут названы: day_{day}_01.jpg, day_{day}_02.jpg, и т.д.\n\nОтправьте фото сейчас, затем напишите 'done' когда закончите.\nНапишите 'skip' для отмены.",
        'update_cancelled': "↩️ Обновление отменено. Возврат в меню.\n\nИспользуйте /start для дополнительных опций.",
